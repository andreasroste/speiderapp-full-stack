      ...
      <div class="grid-3">
        <div
          :class="{
            ...
            filter_active: filters.smaspeider
          }"
          @click="filters.smaspeider = !filters.smaspeider"
        >
          Småspeider
        </div>
        <div
          :class="{
            filtermenubutton: true,
            filter_active: filters.stifinner
          }"
          @click="filters.stifinner = !filters.stifinner"
        >
          Stifinner
        </div>
        <div
          :class="{
            filtermenubutton: true,
            filter_active: filters.vandrer
          }"
          @click="filters.vandrer = !filters.vandrer"
        >
          Vandrer
        </div>
        <div
          :class="{
            filtermenubutton: true,
            filter_active: filters.rover
          }"
          @click="filters.rover = !filters.rover"
        >
          Rover
        </div>
        <div
          :class="{
            filtermenubutton: true,
            filter_active: filters.leder
          }"
          @click="filters.leder = !filters.leder"
        >
          Leder
        </div>
        <div
          :class="{
            filtermenubutton: true,
            filter_active: filters.other_audience
          }"
          @click="filters.other_audience = !filters.other_audience"
        >
          Annet
        </div>
      </div>
